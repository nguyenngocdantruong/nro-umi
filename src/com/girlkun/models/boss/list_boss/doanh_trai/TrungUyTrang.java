    ...
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(BossManager.ratioReward, 100)) {
            if (Util.isTrue(80, 100)) {
             Service.gI().dropItemMap(this.zone,new ItemMap(zone, 861, 1000, this.location.x, this.location.y, plKill.id));
                return;
            }
            Service.gI().dropItemMap(this.zone, Util.ratiItem(zone, Manager.itemIds_TL[randomDo], 1, this.location.x, this.location.y, plKill.id));
        } else {
            ItemMap item = new ItemMap(zone, Manager.itemIds_NR_SB[randomNR], 1, this.location.x, this.location.y, plKill.id);
