...
public class Boss extends Player implements IBossNew, IBossOutfit {
    ...
    public Player getPlayerAttack() {
        ...
        if (this.playerTarget != null && this.playerTarget.effectSkin != null
                && this.playerTarget.effectSkin.isVoHinh) {
            this.playerTarget = null;
            this.lastTimeTargetPlayer = System.currentTimeMillis();
    ...
    public void bossNotify() {
        ...
        if (this != null && !this.isDie() && this.zone != null
                && Util.canDoWithTime(this.lastTimeNotify, this.secondsNotify * 1000)) {
            this.lastTimeNotify = System.currentTimeMillis();
            if (timeToRestart == -1 && data[0].getBossesAppearTogether() != null
                    && data[0].getBossesAppearTogether().length > 1) {
                ...
                ServerNotify.gI().notify("BOSS " + this.name + " vừa xuất hiện tại " + this.zone.map.mapName + " khu "
                        + this.zone.zoneId);
    ...
    public long getLastTimeChatS() {
        return lastTimeChatS;
    }

    public int getTimeChatS() {
        return timeChatS;
    }

    public byte getIndexChatS() {
        return indexChatS;
    }

    public long getLastTimeChatE() {
        return lastTimeChatE;
    }

    public int getTimeChatE() {
        return timeChatE;
    }

    public byte getIndexChatE() {
        return indexChatE;
    }

    public long getLastTimeChatM() {
        return lastTimeChatM;
    }

    public int getTimeChatM() {
        return timeChatM;
    }

    public long getLastTimeNotify() {
        return lastTimeNotify;
    }

    public long getLastTimeTargetPlayer() {
        return lastTimeTargetPlayer;
    }

    public int getTimeTargetPlayer() {
        return timeTargetPlayer;
    }
    ...
    public Player getLockPlayerTarget() {
        return lockPlayerTarget;
    }

    public Boss getParentBoss() {
        return parentBoss;
    }

    public Boss[][] getBossAppearTogether() {
        return bossAppearTogether;
    }

    public Zone getZoneFinal() {
        return zoneFinal;
    }

    public Boss getBossInstance() {
        return bossInstance;
    }
    ...
    public void setLastZone(Zone lastZone) {
    ...
    public void setLastTimeChatS(long lastTimeChatS) {
        this.lastTimeChatS = lastTimeChatS;
    }

    public void setTimeChatS(int timeChatS) {
        this.timeChatS = timeChatS;
    }

    public void setIndexChatS(byte indexChatS) {
        this.indexChatS = indexChatS;
    }

    public void setLastTimeChatE(long lastTimeChatE) {
        this.lastTimeChatE = lastTimeChatE;
    }

    public void setTimeChatE(int timeChatE) {
        this.timeChatE = timeChatE;
    }

    public void setIndexChatE(byte indexChatE) {
        this.indexChatE = indexChatE;
    }

    public void setLastTimeChatM(long lastTimeChatM) {
        this.lastTimeChatM = lastTimeChatM;
    }

    public void setTimeChatM(int timeChatM) {
        this.timeChatM = timeChatM;
    }

    public void setLastTimeNotify(long lastTimeNotify) {
        this.lastTimeNotify = lastTimeNotify;
    }

    public void setTypeBoss(int typeBoss) {
        this.typeBoss = typeBoss;
    }

    public void setLastTimeTargetPlayer(long lastTimeTargetPlayer) {
        this.lastTimeTargetPlayer = lastTimeTargetPlayer;
    }

    public void setTimeTargetPlayer(int timeTargetPlayer) {
        this.timeTargetPlayer = timeTargetPlayer;
    }

    public void setTimeToRestart(long timeToRestart) {
    ...
    public void setLockPlayerTarget(Player lockPlayerTarget) {
        this.lockPlayerTarget = lockPlayerTarget;
    }

    public void setParentBoss(Boss parentBoss) {
        this.parentBoss = parentBoss;
    }

    public void setBossAppearTogether(Boss[][] bossAppearTogether) {
        this.bossAppearTogether = bossAppearTogether;
    }

    public void setZoneFinal(Zone zoneFinal) {
        this.zoneFinal = zoneFinal;
    }

    public void setBossInstance(Boss bossInstance) {
