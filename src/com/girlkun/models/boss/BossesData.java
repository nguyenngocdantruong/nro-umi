...
//**************************************************************************
    ...
    public static final BossData SOI_HEC_QUYN = new BossData(
            ...
            new String[]{}, // text chat S (khởi đầu)
            new String[]{}, // text chat M (giữa trận)
            new String[]{}, // text chat E (kết thúc)
            REST_5_S // thời gian nghỉ giữa các lần spawn
    );
    ...
    public static final BossData O_DO = new BossData(
            ...
            new String[]{}, // text chat S
            new String[]{}, // text chat M
            new String[]{}, // text chat E
            REST_5_S // thời gian nghỉ
    );
    ...
    public static final BossData CHA_PA = new BossData(
            ...
            new String[]{}, new String[]{}, new String[]{}, // text chat
            REST_5_S // secondsRest
    );
    ...
    public static final BossData THIEN_XIN_HANG = new BossData(
            ...
            new int[][]{
                {Skill.DRAGON, 1, 100}, {Skill.DRAGON, 2, 200}, {Skill.DRAGON, 3, 300}, {Skill.DRAGON, 7, 700},
                {Skill.KAMEJOKO, 1, 1000}, {Skill.KAMEJOKO, 2, 1200}, {Skill.KAMEJOKO, 5, 1500}, {Skill.KAMEJOKO, 7, 1700}
            // {Skill.THAI_DUONG_HA_SAN, 1, 15000} // nếu muốn dùng skill này, bỏ comment
            },
            new String[]{}, new String[]{}, new String[]{},
            REST_5_S
    );
    ...
    public static final BossData THIEN_XIN_HANG_CLONE = new BossData(
            ...
            new int[][]{
                {Skill.DRAGON, 1, 100}, {Skill.DRAGON, 2, 200}, {Skill.DRAGON, 3, 300}, {Skill.DRAGON, 7, 700},
                {Skill.KAMEJOKO, 1, 1000}, {Skill.KAMEJOKO, 2, 1200}, {Skill.KAMEJOKO, 5, 1500}, {Skill.KAMEJOKO, 7, 1700}
            // {Skill.THAI_DUONG_HA_SAN, 1, 15000} // nếu cần skill này, chỉ cần bỏ comment
            },
            new String[]{}, new String[]{}, new String[]{},
            REST_5_S
    );
    ...
    //************************************************************************** Halloween Event Bosses
     public static final BossData DRACULA_HALLOWEEN = new BossData(
            "Dracula %d", 
            ConstPlayer.TRAI_DAT, //gender
            ...
            new String[]{"|-1|Ta là trùm halloween mạnh nhất!",
