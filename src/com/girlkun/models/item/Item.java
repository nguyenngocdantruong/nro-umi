...
//        this.itemOptions = _item.itemOptions;
    ...
    public boolean isItemKyGui() {
        for (ItemOption itemOption : itemOptions) {
            if ((itemOption.optionTemplate.id == 87)) {
                return true;
            }
        }
        return false;
    ...
    public boolean isGOKU() {
        return this.template.id == 1264;
    }
    
    public boolean isVEGETA() {
        if (this.template.id == 1265) {
            return true;
        }
        return false;
    }
    ...
    public boolean isDTSC2() {
        for (ItemOption itemOption : itemOptions) {
            if ((this.template.id >= 1048 && this.template.id <= 1062) && itemOption.param >= 1 && itemOption.optionTemplate.id == 15) {
                return true;
            }
        }
        return false;
    ...
    public boolean isKeoHLW() {
        if (this.template.id == 1373 && this.template.id == 1371
                && this.template.id == 1363 && this.template.id == 1365) {
            return true;
        }
        return false;
    }

    public boolean isdaythung() {
        if (this.template.id == 1370) {
            return true;
        }
        return false;
    }
    ...
    public boolean isTrangBiHacHoa() {
        ...
        if ((this.template.type >= 0 && this.template.type < 5) || this.template.type == 32) {
            return true;
        }
