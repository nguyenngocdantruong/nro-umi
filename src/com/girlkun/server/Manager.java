...
public class Manager {
    ...
    public static final short[] itemIds_TL = {555, 557, 559, 556, 558, 560, 562, 564, 566, 563, 565, 567, 561, 232, 233, 236, 237, 240, 241, 244, 245, 248, 249, 252, 253, 256, 257, 260, 261, 264, 265, 268, 269, 272, 273, 276, 277, 278, 279, 280, 281};
    public static final byte[] itemIds_NR_SB = {15, 16, 17, 18, 19, 20};
...
//                        System.out.println(item.getTemp().name + " " + item.getTemp().id);
...
//                            //custom-drsylas
//                            //Biến vàng thành thỏi vàng cho lẹ (457 - id thoi vang)
//                            isHasGoldDrop = true;
//                            item = new ItemMobReward(457, mapDrop,
//                                new int[]{1, 1},
//                                new int[]{20, 100}, gender);
                            mobReward.getGoldReward().add(item);
                        } else {
