...
public class DataGame {
    ...
    public static byte vsData = 84;
    public static byte vsMap = 84;
    public static byte vsSkill = 8;
    public static byte vsItem = 82;
    public static int vsRes = 752013;
    ...
    public static void updateMap(MySession session) {
        ...
        try {
            ...
            // Đếm số NPC templates không null
            int npcCount = 0;
            ...
            // Chỉ gửi các NPC templates không null
            for (NpcTemplate temp : Manager.NPC_TEMPLATES) {
                if (temp != null) {
                    msg.writer().writeUTF(temp.name);
